...
$keterangan = isset($_GET['detail_produk']) ? $_GET['detail_produk'] : '';
$spesifikasi = isset($_GET['spesifikasi']) ? $_GET['spesifikasi'] : '';
    ...
    <div class="col-md-8 col-md-offset-2">
        <form action="process/edit.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="3" required><?php echo $spesifikasi; ?></textarea>
            </div>
            <div class="form-group">
