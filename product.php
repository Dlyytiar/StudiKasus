...
<html>
            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<div class="product-grid" style="background-image:url(uploads/' . $row['gambar'] . ');">';
                        ...
                        echo '</div>';
                        echo '<div class="desc">';
                        echo '<h3><a href="single.php">' . $row['nama_barang'] . '</a></h3>';
    ...
    function confirmDelete() {
        return confirm("Apakah anda yakin ingin menghapus product ini?");
    }
	</script>
	<!-- jQuery -->
